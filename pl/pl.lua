local my_language = {
	...
	press_e_to_loot = "Naciśnij ~b~[E]~w~ aby zgarnąć przedmioty",
	...
	you_used_ammo = "załadowałeś swója broń ~b~%s~w~ amunicją ~b~x%s~w~ z ~b~%s~w~.",
	...
	success_update_name = "Pomyślnie Zmieniłeś imię swojej postaci na ~b~%s~w~.",
	...
	misc_dealer = "Sklep z wyposażeniem",
	...
	character_does_not_exist = "Ta postać nie istnieje.",
	...
	unable_to_find_booster = "Nie można znaleźć ulepszenia z tym id.",
	wait_already_player_boost = "Proszę poczekać moment przed użyciem tego ulepszenia. Jednoosobowe ulepszenie jest już aktywny.",
	wait_already_crew_boost = "Proszę poczekać moment przed użyciem tego ulepszenia. Grupowe ulepszenie jest już aktywny.",
	wait_already_server_boost = "Proszę poczekać moment przed użyciem tego ulepszenia. Serwerowe ulepszenie jest już aktywne.",
	booster_activated = "Ulepszenie aktywny na ~g~%s minuty~w~! ~b~XP +%s%%",
	server_booster_activated = "~b~%s~w~ aktywował ulepszenie serwerowe na ~g~%s minuty~z~! ~b~XP +%s%%",
	crew_booster_activated = "~b~%s~w~ aktywował ulepszenie grupowe na ~g~%s minuty~z~! ~b~XP +%s%%",
	...
	package_sync_success = "~g~Twój zestaw został pomyśnie odebrany, ciesz się!\n~w~Pomocne komendy: /getRank, /booster",
	...
	already_used_reset_only = "~r~Już zresetowałeś swoją postać.\n~w~Only %s~w~ wspierający mogą to robić więcej razy.",
	already_used_reset_only2 = "~r~Już to wykorzystałeś.\n~w~Only %s~w~ tylko wspierający mogą robić to więcej niż jeden raz.",
	...
	customize_weapons = "spersonalizuj broń",
